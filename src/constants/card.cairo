...
pub fn neon_spades_cards() -> Array<u32> {
    array![
        NEON_TWO_SPADES_ID, NEON_THREE_SPADES_ID, NEON_FOUR_SPADES_ID, NEON_FIVE_SPADES_ID, NEON_SIX_SPADES_ID,
        NEON_SEVEN_SPADES_ID, NEON_EIGHT_SPADES_ID, NEON_NINE_SPADES_ID, NEON_TEN_SPADES_ID, NEON_JACK_SPADES_ID,
        NEON_QUEEN_SPADES_ID, NEON_KING_SPADES_ID, NEON_ACE_SPADES_ID,
    ]
}

pub fn all_spades_cards() -> Array<u32> {
    array![
        TWO_SPADES_ID, THREE_SPADES_ID, FOUR_SPADES_ID, FIVE_SPADES_ID, SIX_SPADES_ID, SEVEN_SPADES_ID, EIGHT_SPADES_ID,
        NINE_SPADES_ID, TEN_SPADES_ID, JACK_SPADES_ID, QUEEN_SPADES_ID, KING_SPADES_ID, ACE_SPADES_ID,
        NEON_TWO_SPADES_ID, NEON_THREE_SPADES_ID, NEON_FOUR_SPADES_ID, NEON_FIVE_SPADES_ID, NEON_SIX_SPADES_ID,
        NEON_SEVEN_SPADES_ID, NEON_EIGHT_SPADES_ID, NEON_NINE_SPADES_ID, NEON_TEN_SPADES_ID, NEON_JACK_SPADES_ID,
        NEON_QUEEN_SPADES_ID, NEON_KING_SPADES_ID, NEON_ACE_SPADES_ID,
...
pub fn neon_diamonds_cards() -> Array<u32> {
    array![
        NEON_TWO_DIAMONDS_ID, NEON_THREE_DIAMONDS_ID, NEON_FOUR_DIAMONDS_ID, NEON_FIVE_DIAMONDS_ID, NEON_SIX_DIAMONDS_ID,
        NEON_SEVEN_DIAMONDS_ID, NEON_EIGHT_DIAMONDS_ID, NEON_NINE_DIAMONDS_ID, NEON_TEN_DIAMONDS_ID,
        NEON_JACK_DIAMONDS_ID, NEON_QUEEN_DIAMONDS_ID, NEON_KING_DIAMONDS_ID, NEON_ACE_DIAMONDS_ID,
    ]
}

pub fn all_diamonds_cards() -> Array<u32> {
    array![
        TWO_DIAMONDS_ID, THREE_DIAMONDS_ID, FOUR_DIAMONDS_ID, FIVE_DIAMONDS_ID, SIX_DIAMONDS_ID, SEVEN_DIAMONDS_ID,
        EIGHT_DIAMONDS_ID, NINE_DIAMONDS_ID, TEN_DIAMONDS_ID, JACK_DIAMONDS_ID, QUEEN_DIAMONDS_ID, KING_DIAMONDS_ID,
        ACE_DIAMONDS_ID, NEON_TWO_DIAMONDS_ID, NEON_THREE_DIAMONDS_ID, NEON_FOUR_DIAMONDS_ID, NEON_FIVE_DIAMONDS_ID,
        NEON_SIX_DIAMONDS_ID, NEON_SEVEN_DIAMONDS_ID, NEON_EIGHT_DIAMONDS_ID, NEON_NINE_DIAMONDS_ID,
        NEON_TEN_DIAMONDS_ID, NEON_JACK_DIAMONDS_ID, NEON_QUEEN_DIAMONDS_ID, NEON_KING_DIAMONDS_ID,
        NEON_ACE_DIAMONDS_ID,
    ]
}

pub fn neon_clubs_cards() -> Array<u32> {
    array![
        NEON_TWO_CLUBS_ID, NEON_THREE_CLUBS_ID, NEON_FOUR_CLUBS_ID, NEON_FIVE_CLUBS_ID, NEON_SIX_CLUBS_ID,
        NEON_SEVEN_CLUBS_ID, NEON_EIGHT_CLUBS_ID, NEON_NINE_CLUBS_ID, NEON_TEN_CLUBS_ID, NEON_JACK_CLUBS_ID,
        NEON_QUEEN_CLUBS_ID, NEON_KING_CLUBS_ID, NEON_ACE_CLUBS_ID,
    ]
}

pub fn all_clubs_cards() -> Array<u32> {
    array![
        TWO_CLUBS_ID, THREE_CLUBS_ID, FOUR_CLUBS_ID, FIVE_CLUBS_ID, SIX_CLUBS_ID, SEVEN_CLUBS_ID, EIGHT_CLUBS_ID,
        NINE_CLUBS_ID, TEN_CLUBS_ID, JACK_CLUBS_ID, QUEEN_CLUBS_ID, KING_CLUBS_ID, ACE_CLUBS_ID, NEON_TWO_CLUBS_ID,
        NEON_THREE_CLUBS_ID, NEON_FOUR_CLUBS_ID, NEON_FIVE_CLUBS_ID, NEON_SIX_CLUBS_ID, NEON_SEVEN_CLUBS_ID,
        NEON_EIGHT_CLUBS_ID, NEON_NINE_CLUBS_ID, NEON_TEN_CLUBS_ID, NEON_JACK_CLUBS_ID, NEON_QUEEN_CLUBS_ID,
        NEON_KING_CLUBS_ID, NEON_ACE_CLUBS_ID,
    ]
}
