...
impl GameContextDefault of Default<GameContext> {
    fn default() -> GameContext {
        GameContext {
            ...
            special_idx: 0,
            special_instance_id: 0,
            special_effect_card_id: 0,
            power_ups: array![].span(),
            power_ups_played: array![].span(),
